          ...
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              <button 
                ...
                className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1 transition"
              >
          ...
          <div className="bg-white dark:bg-[#0f172a] rounded-xl shadow-lg dark:shadow-xl border border-gray-100 dark:border-gray-700/30 overflow-hidden transition-colors duration-300">
              ...
              <table className="w-full">
                ...
                <thead className="bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700/70">
                  <tr>
                    ...
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-600 dark:text-gray-400">Change</th>
                    ...
                    rankings.map((item, index) => (
                      <tr 
                        ...
                        className={`border-b border-gray-100 dark:border-gray-700/50 hover:bg-blue-50/30 dark:hover:bg-gray-800/60 transition-colors duration-200 ${
                          item.rank <= 3 ? 'bg-green-50/30 dark:bg-green-900/20' : ''
                        }`}
                      >
                        <td className="py-4 px-6">
            ...
            {!loading && rankings.length === 0 && (
              <div className="text-center py-12 dark:text-gray-300">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No keywords tracked yet</h3>
                <p className="text-gray-500 dark:text-gray-400 mb-4">Start tracking keywords to see their rankings here</p>
                <button 
                  onClick={() => navigate('/keywords')}
